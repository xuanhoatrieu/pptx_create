...
from utils.gemini_image_generator_new import generate_image_with_gemini, generate_image_with_gemini_2_5
    ...
    if uploaded_file is not None:
        try:
            ...
            if st.button(f"Bắt đầu: {generation_mode}", key="generate_presentation_tab1"):
                ...
                processed_slides = []
                image_prompts_list = [] # Initialize list to store image prompts
                ...
                for i, slide in enumerate(slides_data):
                    ...
                    with st.expander(f"Slide {i+1}: {slide.get('title', 'Không có tiêu đề')}", expanded=True):
                        ...
                        image_path = None
                        # Skip image generation for the first two slides (index 0 and 1)
                ...
                # --- Save the image prompts to a text file ---
